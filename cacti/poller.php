...
while ($poller_runs_completed < $poller_runs) {
	...
	if (read_config_option("poller_enabled") == "on") {
		...
		db_execute("REPLACE INTO settings (name,value) VALUES ('date',datetime())");
...
function display_help() {
	echo "Cacti Poller Version " . db_fetch_cell("SELECT cacti FROM version") . ", Copyright 2004-2012 - The Cacti Group\n\n";
