...
function rrdtool_function_create($local_data_id, $show_source, $rrdtool_pipe = "") {
	...
	$rras = db_fetch_assoc("select
		data_template_data.rrd_step as rrd_step,
		rra.x_files_factor as x_files_factor,
		rra.steps as steps,
		rra.rows as rows,
		rra_cf.consolidation_function_id as consolidation_function_id,
	...
	$data_sources = db_fetch_assoc("SELECT
		...
		data_template_rrd.rrd_heartbeat as rrd_heartbeat,
		data_template_rrd.rrd_minimum as rrd_minimum,
		data_template_rrd.rrd_maximum as rrd_maximum,
		data_template_rrd.data_source_type_id as data_source_type_id
...
function rrdtool_function_graph($local_graph_id, $rra_id, $graph_data_array, $rrdtool_pipe = "") {
	...
	$graph = db_fetch_row("select
		...
		graph_local.snmp_query_id snmp_query_id,
		graph_local.snmp_index as snmp_index,
		graph_templates_graph.title_cache as title_cache,
		graph_templates_graph.vertical_label as vertical_label,
		graph_templates_graph.slope_mode as slope_mode,
		graph_templates_graph.auto_scale as auto_scale,
		graph_templates_graph.auto_scale_opts as auto_scale_opts,
		graph_templates_graph.auto_scale_log as auto_scale_log,
		graph_templates_graph.scale_log_units as scale_log_units,
		graph_templates_graph.auto_scale_rigid auto_scale_rigid,
		graph_templates_graph.auto_padding as auto_padding,
		graph_templates_graph.base_value as base_value,
		graph_templates_graph.upper_limit as upper_limit,
		graph_templates_graph.lower_limit as lower_limit,
		graph_templates_graph.height as height,
		graph_templates_graph.width as width,
		graph_templates_graph.image_format_id as image_format_id,
		graph_templates_graph.unit_value as unit_value,
		graph_templates_graph.unit_exponent_value as unix_exponent_value,
		graph_templates_graph.export as export
	...
	$graph_items = db_fetch_assoc("select
		...
		graph_templates_item.cdef_id as cdef_id,
		graph_templates_item.text_format as text_format,
		graph_templates_item.value as value,
		graph_templates_item.hard_return as hard_return,
		...
		graph_templates_gprint.gprint_text as gprint_text,
		colors.hex as hex,
		graph_templates_item.alpha as alpha,
		data_template_rrd.id as data_template_rrd_id,
		data_template_rrd.local_data_id as local_data_id,
		data_template_rrd.rrd_minimum as rrd_minimum,
		data_template_rrd.rrd_maximum as rrd_maximum,
		data_template_rrd.data_source_name as data_source_name,
		data_template_rrd.local_data_template_rrd_id as local_data_template_rrd_id
...
function rrdtool_function_xport($local_graph_id, $rra_id, $xport_data_array, &$xport_meta) {
	...
	$graph = db_fetch_row("select
		graph_local.id AS local_graph_id,
		graph_local.host_id as host_id,
		graph_local.snmp_query_id as snmp_query_id,
		graph_local.snmp_index as snmp_index,
		graph_templates_graph.title_cache as title_cache,
		graph_templates_graph.vertical_label as vertical_label,
		graph_templates_graph.slope_mode as slope_mode,
		...
		graph_templates_graph.auto_scale_log as auto_scale_log,
		graph_templates_graph.scale_log_units as scale_log_units,
		graph_templates_graph.auto_scale_rigid as auto_scale_rigid,
		graph_templates_graph.auto_padding as auto_padding,
		graph_templates_graph.base_value as base_value,
		graph_templates_graph.upper_limit as upper_limit,
		graph_templates_graph.lower_limit as lower_limit,
		...
		graph_templates_graph.image_format_id as image_format_id,
		graph_templates_graph.unit_value as unit_value,
		graph_templates_graph.unit_exponent_value as unit_exponent_value,
		graph_templates_graph.export as export
		from (graph_templates_graph,graph_local)
		where graph_local.id=graph_templates_graph.local_graph_id
		and graph_templates_graph.local_graph_id=$local_graph_id");
