...
function api_poller_cache_item_add($host_id, $host_field_override, $local_data_id, $rrd_step, $poller_action_id, $data_source_item_name, $num_rrd_items, $arg1 = "", $arg2 = "", $arg3 = "") {
	...
	$host = db_fetch_row("select
		...
		host.snmp_community as snmp_community,
		host.snmp_version as snmp_version,
		host.snmp_username as snmp_username,
		host.snmp_password as snmp_password,
		host.snmp_auth_protocol as snmp_auth_protocol,
		host.snmp_priv_passphrase as snmp_priv_passphrase,
		host.snmp_priv_protocol as snmp_priv_protocol,
		host.snmp_context as snmp_context,
		host.snmp_port as snmp_port,
		host.snmp_timeout as snmp_timeout,
		host.disabled as disabled
		from host
