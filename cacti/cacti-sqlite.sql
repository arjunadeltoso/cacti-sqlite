...
CREATE TABLE "data_template_data" (
  ...
  "rrd_step" mediumint(8)  NOT NULL DEFAULT '0',
...
CREATE TABLE "graph_tree" (
  "id" INTEGER  NOT NULL ,
  "sort_type" tinyint(3)  NOT NULL DEFAULT '1',
  "name" varchar(255) NOT NULL DEFAULT '',
  PRIMARY KEY ("id")
);
...
CREATE TABLE "graph_tree_items" (
  ...
  "local_graph_id" mediumint(8)  NOT NULL DEFAULT '0',
  "rra_id" smallint(8)  NOT NULL DEFAULT '0',
  "title" varchar(255) DEFAULT NULL,
  "host_id" mediumint(8)  NOT NULL DEFAULT '0',
  "order_key" varchar(100) NOT NULL DEFAULT '0',
  "host_grouping_type" tinyint(3)  NOT NULL DEFAULT '1',
  "sort_children_type" tinyint(3)  NOT NULL DEFAULT '1',
  PRIMARY KEY ("id")
);
...
CREATE TABLE "host" (
  ...
  "snmp_port" mediumint(5)  NOT NULL DEFAULT '161',
  "snmp_timeout" mediumint(8)  NOT NULL DEFAULT '500',
  "availability_method" smallint(5)  NOT NULL DEFAULT '1',
  "ping_method" smallint(5)  DEFAULT '0',
  "ping_port" int(12)  DEFAULT '0',
  "ping_timeout" int(12)  DEFAULT '500',
  "ping_retries" int(12)  DEFAULT '2',
  "max_oids" int(12)  DEFAULT '10',
  "device_threads" tinyint(2)  NOT NULL DEFAULT '1',
  ...
  "total_polls" int(12)  DEFAULT '0',
  "failed_polls" int(12)  DEFAULT '0',
...
CREATE TABLE "host_snmp_query" (
  ...
  "reindex_method" tinyint(3)  NOT NULL DEFAULT '0',
...
CREATE TABLE "poller_item" (
  ...
  "snmp_context" varchar(64) DEFAULT '',
  "snmp_port" mediumint(5)  NOT NULL DEFAULT '161',
  "snmp_timeout" mediumint(8)  NOT NULL DEFAULT '0',
  "rrd_name" varchar(19) NOT NULL DEFAULT '',
  "rrd_path" varchar(255) NOT NULL DEFAULT '',
  "rrd_num" tinyint(2)  NOT NULL DEFAULT '0',
...
CREATE TABLE "poller_reindex" (
  "host_id" mediumint(8)  NOT NULL DEFAULT '0',
  "data_query_id" mediumint(8)  NOT NULL DEFAULT '0',
  "action" tinyint(3)  NOT NULL DEFAULT '0',
  "present" tinyint(4) NOT NULL DEFAULT '1',
...
CREATE TABLE "rra" (
  ...
  "timespan" int(12)  NOT NULL DEFAULT '0',
  PRIMARY KEY ("id")
);
...
CREATE TABLE "user_auth" (
  ...
  "policy_graphs" tinyint(1)  NOT NULL DEFAULT '1',
  "policy_trees" tinyint(1)  NOT NULL DEFAULT '1',
  "policy_hosts" tinyint(1)  NOT NULL DEFAULT '1',
  "policy_graph_templates" tinyint(1)  NOT NULL DEFAULT '1',
...
CREATE INDEX "poller_item_local_data_id" ON "poller_item" ("local_data_id");
CREATE INDEX "poller_item_host_id" ON "poller_item" ("host_id");
CREATE INDEX "poller_item_rrd_next_step" ON "poller_item" ("rrd_next_step");
CREATE INDEX "poller_item_action" ON "poller_item" ("action");
CREATE INDEX "poller_item_present" ON "poller_item" ("present");
CREATE INDEX "user_auth_perms_user_id" ON "user_auth_perms" ("user_id","type");
CREATE INDEX "snmp_query_name" ON "snmp_query" ("name");
CREATE INDEX "data_template_data_rra_data_template_data_id" ON "data_template_data_rra" ("data_template_data_id");
CREATE INDEX "poller_reindex_present" ON "poller_reindex" ("present");
CREATE INDEX "data_template_data_local_data_id" ON "data_template_data" ("local_data_id");
CREATE INDEX "data_template_data_data_template_id" ON "data_template_data" ("data_template_id");
CREATE INDEX "data_template_data_data_input_id" ON "data_template_data" ("data_input_id");
CREATE INDEX "data_input_data_t_value" ON "data_input_data" ("t_value");
CREATE INDEX "data_input_name" ON "data_input" ("name");
CREATE INDEX "snmp_query_graph_rrd_sv_snmp_query_graph_id" ON "snmp_query_graph_rrd_sv" ("snmp_query_graph_id");
CREATE INDEX "snmp_query_graph_rrd_sv_data_template_id" ON "snmp_query_graph_rrd_sv" ("data_template_id");
CREATE INDEX "graph_templates_item_graph_template_id" ON "graph_templates_item" ("graph_template_id");
CREATE INDEX "graph_templates_item_local_graph_id" ON "graph_templates_item" ("local_graph_id");
CREATE INDEX "graph_templates_item_task_item_id" ON "graph_templates_item" ("task_item_id");
CREATE INDEX "snmp_query_graph_sv_snmp_query_graph_id" ON "snmp_query_graph_sv" ("snmp_query_graph_id");
CREATE INDEX "host_disabled" ON "host" ("disabled");
CREATE INDEX "graph_tree_items_graph_tree_id" ON "graph_tree_items" ("graph_tree_id");
CREATE INDEX "graph_tree_items_host_id" ON "graph_tree_items" ("host_id");
CREATE INDEX "graph_tree_items_local_graph_id" ON "graph_tree_items" ("local_graph_id");
CREATE INDEX "graph_tree_items_order_key" ON "graph_tree_items" ("order_key");
CREATE INDEX "data_template_rrd_duplicate_dsname_contraint" ON "data_template_rrd" ("local_data_id","data_source_name","data_template_id");
CREATE INDEX "data_template_rrd_local_data_id" ON "data_template_rrd" ("local_data_id");
CREATE INDEX "data_template_rrd_data_template_id" ON "data_template_rrd" ("data_template_id");
CREATE INDEX "data_template_rrd_local_data_template_rrd_id" ON "data_template_rrd" ("local_data_template_rrd_id");
CREATE INDEX "host_snmp_query_host_id" ON "host_snmp_query" ("host_id");
CREATE INDEX "graph_local_host_id" ON "graph_local" ("host_id");
CREATE INDEX "graph_local_graph_template_id" ON "graph_local" ("graph_template_id");
CREATE INDEX "graph_local_snmp_query_id" ON "graph_local" ("snmp_query_id");
CREATE INDEX "graph_local_snmp_index" ON "graph_local" ("snmp_index");
CREATE INDEX "snmp_query_graph_rrd_data_template_rrd_id" ON "snmp_query_graph_rrd" ("data_template_rrd_id");
CREATE INDEX "snmp_query_graph_rrd_snmp_query_graph_id" ON "snmp_query_graph_rrd" ("snmp_query_graph_id");
CREATE INDEX "rra_cf_rra_id" ON "rra_cf" ("rra_id");
CREATE INDEX "plugin_config_status" ON "plugin_config" ("status");
CREATE INDEX "plugin_config_directory" ON "plugin_config" ("directory");
CREATE INDEX "cdef_items_cdef_id" ON "cdef_items" ("cdef_id");
CREATE INDEX "user_auth_username" ON "user_auth" ("username");
CREATE INDEX "user_auth_realm1" ON "user_auth" ("realm");
CREATE INDEX "user_auth_enabled" ON "user_auth" ("enabled");
CREATE INDEX "plugin_db_changes_plugin" ON "plugin_db_changes" ("plugin");
CREATE INDEX "plugin_db_changes_method" ON "plugin_db_changes" ("method");
CREATE INDEX "host_snmp_cache_host_id" ON "host_snmp_cache" ("host_id","field_name");
CREATE INDEX "host_snmp_cache_snmp_index" ON "host_snmp_cache" ("snmp_index");
CREATE INDEX "host_snmp_cache_field_name" ON "host_snmp_cache" ("field_name");
CREATE INDEX "host_snmp_cache_field_value" ON "host_snmp_cache" ("field_value");
CREATE INDEX "host_snmp_cache_snmp_query_id" ON "host_snmp_cache" ("snmp_query_id");
CREATE INDEX "host_snmp_cache_present" ON "host_snmp_cache" ("present");
CREATE INDEX "graph_templates_name" ON "graph_templates" ("name");
CREATE INDEX "plugin_hooks_hook" ON "plugin_hooks" ("hook");
CREATE INDEX "plugin_hooks_status" ON "plugin_hooks" ("status");
CREATE INDEX "host_template_graph_host_template_id" ON "host_template_graph" ("host_template_id");
CREATE INDEX "graph_template_input_defs_graph_template_input_id" ON "graph_template_input_defs" ("graph_template_input_id");
CREATE INDEX "data_input_fields_data_input_id" ON "data_input_fields" ("data_input_id");
CREATE INDEX "data_input_fields_type_code" ON "data_input_fields" ("type_code");
CREATE INDEX "user_log_username" ON "user_log" ("username");
CREATE INDEX "user_log_user_id" ON "user_log" ("user_id");
CREATE INDEX "host_template_snmp_query_host_template_id" ON "host_template_snmp_query" ("host_template_id");
CREATE INDEX "user_auth_realm_user_id" ON "user_auth_realm" ("user_id");
CREATE INDEX "plugin_realms_plugin" ON "plugin_realms" ("plugin");
CREATE INDEX "graph_templates_graph_local_graph_id" ON "graph_templates_graph" ("local_graph_id");
CREATE INDEX "graph_templates_graph_graph_template_id" ON "graph_templates_graph" ("graph_template_id");
CREATE INDEX "graph_templates_graph_title_cache" ON "graph_templates_graph" ("title_cache");
END TRANSACTION;
